    ...
    <>
      {showDraftPopup && (
        <div 
          ...
          style={{ zIndex: 999 }}
        >
          <div className="bg-[#191b21] backdrop-blur-2xl border border-[#9E9FA74D] rounded-lg p-8 max-w-2xl w-full relative">
            <button
            ...
            <div className="space-y-6">
              <div>
                <label className="text-white text-sm mb-2 block text-start">TITLE</label>
                <input
                  type="text"
                  value={formData.title}
                  onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                  className="w-full bg-transparent border-b border-[#9E9FA74D] text-white px-2 py-1 focus:outline-none focus:border-blue-500"
                />
              </div>
              ...
              <div>
                <label className="text-white text-sm mb-2 block text-start">DETAILS</label>
              ...
              <div className="text-end">
                <button className="text-white text-sm flex items-center gap-2 mx-auto hover:text-gray-300 transition-colors">
                  UPLOAD MEDIA/FILE
                  <Upload size={16} />
                </button>
              </div>
              ...
              <div className="flex gap-4 justify-center pt-4">
                <button className="px-6 py-2 border border-[#9E9FA74D] text-white text-sm rounded hover:bg-gray-800 transition-colors">
                  Save Draft
                </button>
                <button
                  onClick={handleSendToSpecific}
                  className="px-6 py-2 border border-[#9E9FA74D] text-white text-sm rounded hover:bg-gray-800 transition-colors"
                >
                  Specific
                </button>
                <button
      ...
      {showRecipientPopup && (
        <div 
          ...
          style={{ zIndex: 1000 }}
        >
          <div className="bg-[#191b21] border border-[#9E9FA74D] rounded-lg p-6 mb-4 max-w-sm w-full relative">
            <button
              onClick={() => setShowRecipientPopup(false)}
              className="absolute top-1 right-4 text-gray-400 hover:text-white"
            >
              <X size={24} />
            </button>
            ...
            <div className="text-right">
              <button
                ...
                className="px-8 py-2 border border-[#9E9FA74D] text-white text-sm rounded hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                SEND
              </button>
            </div>
