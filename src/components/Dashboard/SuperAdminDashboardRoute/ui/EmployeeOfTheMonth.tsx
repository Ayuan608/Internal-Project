...
const EmployeeOfTheMonthAdmin = () => {
  ...
  const departments = [
    {
      id: "csr",
      name: "Customer Service Representative Department",
      color: "blue",
    },
  ...
  const [employees, setEmployees] = useState([
    {
      id: 1,
      name: "Sarah Johnson",
      department: "Customer Service Representative Department",
      month: "September",
      year: 2025,
      achievements:
        "Handled 500+ customer inquiries with 98% satisfaction rate",
      message:
        "Sarah has consistently demonstrated exceptional dedication and professionalism.",
      hasGoodPerformance: true,
      hasNoLate: true,
      hasNoMissingPunches: true,
    ...
    },
    {
      ...
      month: "September",
      year: 2025,
      achievements: "Processed 2000+ deposits with zero errors",
      message:
        "Michael's attention to detail and efficiency is truly remarkable.",
      hasGoodPerformance: true,
      hasNoLate: true,
      hasNoMissingPunches: true,
      datePosted: "2025-09-01",
  ...
  const getColorClasses = (color: "blue" | "emerald" | "purple") => {
    const colors = {
      ...
      emerald:
        "text-emerald-400 bg-emerald-500/10 border-emerald-500/20 hover:border-emerald-500/30",
      purple:
        "text-purple-400 bg-purple-500/10 border-purple-500/20 hover:border-purple-500/30",
    };
      ...
      <div className="w-full">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-6">
              {departments.map((dept) => (
                <div
                  key={dept.id}
                  className={`bg-[rgba(59,130,246,0.03)] cursor-pointer backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 hover:border-${dept.color}-500/30 hover:shadow-lg transition-all duration-300`}
                >
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white rounded-xl font-bold transition-all duration-300 shadow-lg shadow-amber-500/30 hover:shadow-amber-500/50"
                  >
                  ...
                  <button
                    ...
                    className="px-8 py-4 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl font-bold transition-all duration-300 border border-slate-700"
                  >
                    Clear Form
                  </button>
                </div>
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-8 max-w-md mx-4 shadow-2xl">
