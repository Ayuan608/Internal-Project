...
const TabsTrigger = React.forwardRef(({ className, value, children, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      className={`inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-2 text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 ${isSelected ? 'text-white bg-slate-800' : 'text-slate-400 hover:text-white'} ${className}`}
