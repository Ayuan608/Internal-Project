            ...
            <div className="max-w-full mx-auto">
                ...
                <div className="flex gap-3 mb-6">
                    <button
                        ...
                        className={`px-6 py-2 rounded-lg font-medium transition-all border ${viewType === "weekly"
                                ? "bg-[#10131f] text-white shadow-md  border=gray-500"
                    ...
                    <button
                        ...
                        className={`px-6 py-2 rounded-lg font-medium transition-all border ${viewType === "monthly"
                                ? "bg-[#10131f] text-white shadow-md  border=gray-500"
                                : "text-white/70  border-gray-500"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`ml-auto px-6 py-2 rounded-lg font-medium transition-all ${showStats
                                ...
                                {currentData.map((row, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <span
                                                className={`inline-block px-2 py-1 rounded text-lg font-medium ${row.missed > 3
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <span
                                                className={`inline-block px-2 py-1 rounded text-sm font-medium ${row.frt > 12
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <span
                                                className={`inline-block px-2 py-1 rounded text-sm font-medium ${row.mistakes > 2
                                                        ? "bg-red-100 text-red-700"
                                                        : "bg-green-100 text-green-700"
                                                    }`}
                                            >
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span
                                                    className={`flex items-center gap-1 text-sm font-semibold px-2 py-1 rounded ${isPositive
                                                            ? "bg-emerald-100 text-emerald-700"
                                                            : "bg-red-100 text-red-700"
                                                        }`}
                                                >
