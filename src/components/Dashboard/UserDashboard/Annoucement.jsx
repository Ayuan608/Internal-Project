              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <button
                    ...
                    className="ml-4 px-5 py-2 bg-[#3b82f6] text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-sm hover:shadow-md font-medium"
                  >
                    View Details
                  </button>
                </div>
