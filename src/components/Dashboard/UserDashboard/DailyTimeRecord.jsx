      ...
      <div className="min-h-screen p-4">
                ...
                <tbody>
                  {currentData.records.map((record, index) => (
                    <tr key={index} className="hover:bg-[#10101b]">
                      ...
                      <td className="px-6 py-4 text-sm">{record.punchIn}</td>
                      <td className="px-6 py-4 text-sm">{record.breaks}</td>
                      <td className="px-6 py-4 text-sm">{record.punchOut}</td>
        ...
        <div className="bg-blue-50 border pt-4 border-blue-200 text-blue-800 px-4 py-3 rounded-lg mb-6 flex items-start gap-3">
          ...
          <p className="text-sm">
            ...
            official Daily Time Record. All entries are automatically recorded
            by the system and cannot be modified. If you notice any
            discrepancies, please contact your Team Leader or HR department.
          </p>
        </div>
    </>
  );
