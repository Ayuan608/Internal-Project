...
>
  ...
  <div
    className={`flex flex-col gap-4 transition-all duration-500 ${
      requireOtp ? "opacity-70" : "opacity-100"
    }`}
  >
    ...
    {!requireOtp && (
      ...
      <div
    className={`flex flex-col gap-2 mt-4 overflow-hidden transition-all duration-500 ${
      requireOtp ? "max-h-40 opacity-100" : "max-h-0 opacity-0"
    }`}
  >
    <input
      type="text"
